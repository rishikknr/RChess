            ...
            if(!this.board.getTile(5).isTileOccupied() && !this.board.getTile(6).isTileOccupied()){
                ...
                if(rookTile.isTileOccupied() && rookTile.getPiece().isFirstMove() ){
                    if(Player.calculateAttacksOnTile(5, opponentsLegals).isEmpty() &&
                        ...
                        kingCastles.add(new KingSideCastelMove(this.board, this.playerKing, 6, (Rook)rookTile.getPiece(),
            ...
            if(!this.board.getTile(1).isTileOccupied() && !this.board.getTile(2).isTileOccupied() && !this.board.getTile(3).isTileOccupied()){
                ...
                if(rookTile.isTileOccupied() && rookTile.getPiece().isFirstMove() ){
                    if(Player.calculateAttacksOnTile(1, opponentsLegals).isEmpty() &&
                            ...
                            rookTile.getPiece().getPieceType().isRook()) {
                        kingCastles.add(new QueenSideCastelMove(this.board, this.playerKing, 2, (Rook)rookTile.getPiece(),
