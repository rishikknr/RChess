    ...
    protected Collection<Move> calculateKingCastles(final Collection<Move> playerLegals,final Collection<Move> opponentsLegals) {
        ...
        if(this.playerKing.isFirstMove() && !this.isInCheck()){
            ...
            if(!this.board.getTile(61).isTileOccupied() && !this.board.getTile(62).isTileOccupied()){
                ...
                if(rookTile.isTileOccupied() && rookTile.getPiece().isFirstMove() ){
                    if(Player.calculateAttacksOnTile(61, opponentsLegals).isEmpty() &&
                        ...
                        kingCastles.add(new KingSideCastelMove(this.board, this.playerKing, 62, (Rook)rookTile.getPiece(),
            ...
            if(!this.board.getTile(59).isTileOccupied() && !this.board.getTile(58).isTileOccupied() && !this.board.getTile(57).isTileOccupied()){
                ...
                //Should check this code once #32
                if(rookTile.isTileOccupied() && rookTile.getPiece().isFirstMove() ){
                    if(Player.calculateAttacksOnTile(59, opponentsLegals).isEmpty() &&
                            ...
                            rookTile.getPiece().getPieceType().isRook()) {
                        kingCastles.add(new QueenSideCastelMove(this.board, this.playerKing, 58, (Rook)rookTile.getPiece(),
